...
<body>
	<a href="?" style="font-size: 20px; font-family:SimSun;">任务管理系统</a>
	<?php
        $CI =& get_instance();
	...
	<?php echo form_open('index/formsubmit'); ?>
		任务名称：
		<input name="tasktitle" type="text" style="width:30%"></input>  &nbsp&nbsp&nbsp&nbsp &nbsp&nbsp&nbsp&nbsp
        <input type="checkbox" name="completed" value="1">已完成</input>
        <br/>
		任务内容：
