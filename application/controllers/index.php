  ...
  class Index extends CI_Controller{
      ...
      */
      function getTaskByDptid(){
         ...
         //file_put_contents('c:\error.txt',$dtpId.$startDate);  
...
//           echo $temp;
      ...
      function getTaskByDptid_gantt(){
           $dptId = $this->input->post('dptId');
           $startDate = $this->input->post('startDate');
           $endDate = $this->input->post('endDate');
           $displayAll = $this->input->post('displayAll');
           $rows = $this->task->getTaskByDptid_gantt($dptId,$displayAll,$startDate,$endDate);
           $temp= json_encode($rows);
           echo $temp;
      }
